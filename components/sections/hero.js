        ...
        <AnimatePresence initial={false} custom={direction}>
          ...
          >
            <div className="relative h-full w-full">
              ...
              {/* Brand Color Overlay */}
              {/* <div className="absolute inset-0 bg-gradient-to-br from-[#ff4f01]/10 via-transparent to-[#ff6b2e]/10" /> */}
            </div>
          </motion.div>
        </AnimatePresence>
      </div>
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              >
                {banners[currentSlide].title.split(' ').slice(0, 2).join(' ')}
              </motion.span>
              <motion.span
              ...
              >
                {banners[currentSlide].title.split(' ').slice(2).join(' ')}
              </motion.span>
            </motion.h1>
          </motion.div> */}
          ...
          {banners.map((_, index) => (
            <motion.div
              ...
              className={`w-12 h-1.5 rounded-full transition-all duration-500 ${
                index === currentSlide ? 'bg-[#ff4f01]' : 'bg-white/30'
              }`}
